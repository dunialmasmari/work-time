     ...
     <div class="col-md-12  d-md-block ">
       <div class='card-body bg-white  mb-4 ' align='center'>
          <div class="avatar-med">
              <img class="avatar-img rounded-circle" src="{{URL::asset('assets/uploads/services/images/'.$service->image)}}" />
          </div>    
          <h4 class="my-3">{{$service->title}}</h4>
          <a href="../service/{{$service->service_id}}"><button class='btn btn-primary btn-md my-2 ' style="float: none;width:60%" >  {{__('fields_web.Tenders.more')}} </button></a>
       </div>
     </div>
   </div> 
  @endforeach
