      ...
      <div class="row">
        ...
        <div class="col-md-12">
             ...
             <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" id="form" name = "myForm" onsubmit = "return(validate());" action="{{route('storeTender')}}" method="post" 
                enctype="multipart/form-data" >
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {{__('fields_web.TenderValidate.fileMassage')}} </small>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input id="company" type="text" name="company" placeholder="{{__('fields_web.TenderAdd.Company')}}" class="form-control"  >
                    ...
                    <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                  <div class="custom-file">
                                    <input ref="fileInput" name="image" id="file-ip-1"  accept="image/*" multiple="false" type="file" onchange="showPreview(event);" class="custom-file-input">
                  ...
                  <div class="card-footer">
                    <button type="submit" id="submitadd" class="btn btn-primary">{{__('fields_web.TenderAdd.Submit')}} </button>
                  </div>
                </form>
              </div>
              <!-- /.card -->
