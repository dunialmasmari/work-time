      ...
      <div class="row">
        ...
        <div class="col-md-12">
             ...
             <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" name = "myForm" onsubmit = "return(validate());" action="{{route('storeJob')}}"
                    ...
                    <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input  name="image" id="file-ip-1"  accept="image/*" multiple="false" onchange="showPreview(event);" type="file" class="custom-file-input">
