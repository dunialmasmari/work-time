                                            ...
                                            <div class='col-12 col-sm-12 col-md-12 col-lg-12 '>
                                                ...
                                                <form action="{{ route('sendCV') }}" class="was-validated"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" id='user_cv' class="form-control" name="user_cv"
                                                            required accept=".pdf" />
                                                        <div class="valid-feedback"></div>
                                                        <div class="invalid-feedback">
                                                    ...
                                                    @if ($job->recommendation == 1)
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" id='name_RCOM' class="form-control"
                                                                name="user_recommendation" accept=".pdf" style="display: "
                                                                required />
                                                            <div class="valid-feedback"></div>
                                                            <div class="invalid-feedback">
                                                                {{ __('fields_web.Jobs.req_pdf') }} </div>
                                                    ...
                                                    @else
                                                        <input type="email" class="form-control" name="user_recommendation"
                                                            hidden value=''>
