...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link menu  btn btn-md  "
    ...
    <form class="form-inline ml-3 ">
        <div class="input-group input-group-sm">
            <input class="form-control form-control-navbar" type="search"
                placeholder="{{ __('fields_web.Notification.Search') }}" aria-label="Search">
    ...
    <ul class="navbar-nav ml-auto dropdown-menu-text">
        ...
        <li class="nav-item dropdown dropdown-message">
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                <i data-count='0' class="badge badge-danger navbar-badge notif-count"
                    style='content: attr(data-count);'></i>
            </a>
          ...
          <a href="#" class="dropdown-item">
            ...
            <!- Message End ->
                ...
                <a href="{{ route('Messages') }}"
                    class="dropdown-item dropdown-footer">{{ __('fields_web.Notification.MessagesAll') }}</a>
            </div>
        </li>
        ...
        <li class="nav-item dropdown dropdown-notifications ">
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                <span data-count="0" class=" badge badge-danger navbar-badge notif-count"
                    style='content: attr(data-count);'></span>
            </a>
          ...
          <a href="#" class="dropdown-item">
              <div class='row'>
                ...
                <a href="{{ route('Notifications') }}"
                    class="dropdown-item dropdown-footer">{{ __('fields_web.Notification.NotificationsAll') }}</a>
            </div>
       ...
       <!-- <a href="` + url + `" class="dropdown-item">
        ...
        <!--<div class="dropdown-divider"></div>
          ...
          <div class='row'>
                ...
                <div class='col-3'><i class="text-sm text-muted" style='height:auto;word-wrap: break-word'>` + data
                .message + `</i></div>
              </div>
          </a>-->
        `;
