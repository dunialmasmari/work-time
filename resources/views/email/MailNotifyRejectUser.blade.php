...
<head>
    ...
    <title>رفض الاشتراك في الموقع</title>
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                            ...
                            <div style="line-height: 35px">
                             ...
                             تم رفض <span style="color: #5caad2;">طلبك بالاشتراك</span>
...
<!-- data of tender ////////////////////////////////////////////////////-->
                                        ...
                                        <h3>لقد تم رفض طلبكم بالاشتراك في موقع ورك تايم </h3>
                                        {{--<!--<h2>اسم المستخدم : {{$data}} </h2>
                                         <h2>الايميل الخاص بك  : {{$data['Email']}} <h2> -->--}}
                                         <h3>يرجى اعادة انشاء حساب من جديد والتاكد من كافة المعلومات لديكم </h3>
                                        <h3>لانشاء حساب قم بالنقر على زر انشاء حساب  </h3>
...
<!-- link of tender ////////////////////////////////////////////////////-->
                                        <div style="line-height: 26px;">
                                            <a href="https://worktime-ye.com/ar/companysignup" style="color: #ffffff; text-decoration: none;">انشاء حساب  </a>
                                        </div>
                                    </td>
                                </tr>
