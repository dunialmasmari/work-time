...
<!-- data of tender ////////////////////////////////////////////////////-->
                                        ...
                                        <h3>عذراً لقد تم رفض الوظيفة التي انزلتها يرجى التاكد من كل معلوماتك فيها واعادة ادخالها من جديد<h3>
                                        <h1>العنوان :{{$data['title']}} </h1>
                                        <h2>الجهة المقدمة :{{$data['company']}} <h2>
                                        {{-- <!-- <h3>القسم :{{$data['major_name']}}<h3> -->--}}
                                        {{-- <!-- <h3>id :{{$data['job_id']}}<h3> -->--}}
                                        </div>
                                    </td>
                                </tr>
                            </table>
...
<!-- link of tender ////////////////////////////////////////////////////-->
                                        <div style="line-height: 26px;">
                                            <a href="https://worktime-ye.com/ar/Jobdetilse/{{$data['job_id']}}" style="color: #ffffff; text-decoration: none;">مزيد من المعلومات</a>
                                        </div>
                                    </td>
                                </tr>
