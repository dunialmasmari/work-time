                            ...
                            @endif
                             ...
                             @if($user->active == 1)
                                ...
                                <td>
                                    ...
                                    <a href="{{  route('SercheUseractivation' ,$user->user_id) }}" class="btn btn-outline-primary" href="#"><i class="fas fa-lightbulb"></i></a>
                              </td>
                              @else 
                              <td><span class="badge badge-danger">{{__('fields_web.Users.notActive')}}</span></td>
                              <td>
                                    <a href="{{  route('viewUserdetilse',$user->user_id) }}"class="btn btn-outline-primary"> <i class="fas fa-eye"></i></a>
                                    <a href="{{  route('SercheUseractivation' ,$user->user_id) }}" class="btn btn-outline-primary" href="#"><i class="far fa-lightbulb"></i></a>
                              </td>
                              @endif  
                          </tr>
                          @endforeach
