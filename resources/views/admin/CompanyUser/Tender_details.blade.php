    ...
    <div class="container-fluid">
      ...
      @foreach ($tenders as $tender)
           ...
           @if($tender->active == 1)
                        <div class="col-sm-12 col-md-12">
                            <div class="color-palette-set">
                                <div class="bg-success info-box disabled color-palette"><span>{{(__('fields_web.Notification.activeTender'))}}</span></div>
                             </div>
                        </div>
                @endif
                     <!-- ///////////////////////////////////////////////// -->
                ...
                @if($tender->active == 2)
                       ...
                       <div class="col-sm-12 col-md-12">
                               <div class="color-palette-set">
                                   <div class="bg-warning info-box disabled color-palette"><span>{{(__('fields_web.Notification.waitingTender'))}}</span></div>
                               </div>
                            </div>
                            <h5 class="card-title col-6">{{(__('fields_web.Notification.postTendermessage'))}}</h5>
                                                      ...
                                                      <div class="modal-content ">
                                                          <div class="modal-header">
                                                           ...
                                                           <div class="modal-footer justify-content-between">
                                                                 ...
                                                                 <a href="{{route('acceptTender',$tender->tender_id)}}">
                                              ...
                                              <div class="modal fade" id="modal-warning">
                                                 <div class="modal-dialog modal-sm">
                                                   <div class="modal-content ">
                                                      ...
                                                      <div class="modal-footer justify-content-between">
                                                         <button type="button" class="btn btn-default" data-dismiss="modal">{{(__('fields_web.Notification.rejectNo'))}}</button>
                                                         <a href="{{route('rejectTender',$tender->tender_id)}}">
